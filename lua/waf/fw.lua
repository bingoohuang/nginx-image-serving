...
local ac = require("waf.inc.load_ac")
local cjson = require("cjson")
local cookiejar = require("waf.inc.resty.cookie")
local file_logger = require("waf.inc.resty.logger.file")
local socket_logger = require("waf.inc.resty.logger.socket")
...
function _M.new(self)
	return setmetatable({
		...
		_whitelist = {},
		_blacklist = {},
		_active_rulesets = { 10000,20000,21000,40000,41000,42000,90000,99000 },
		_ignored_rules = {},
